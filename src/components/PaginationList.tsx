...
import { PaginationListPropsModel } from 'models/PaginationListPropsModel';
import { OrdersModel } from 'models/OrdersModel';

const ITEMS_PER_PAGE = 10;

const PaginationList: React.FC<PaginationListPropsModel> = ({ data }) => {
  if (!data) {
    ...
    <div className="p-4 w-full max-w-10xl mx-auto">
      <div className="bg-white shadow-md rounded-lg">
        ...
        <ul className="divide-y divide-gray-200">
          {selectedItems.map((item: OrdersModel) => (
